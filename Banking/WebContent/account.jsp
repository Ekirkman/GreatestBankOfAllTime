...
<a class="btn btn-primary" href="OpenAccountServelet" role="button" >Open new Account</a>
 <button type="button" class="btn btn-danger">Close This Account</button>
<h2> Account Name: </h2>
<h3>${customer.getAccounts().get(customer.getAccounts().size()-1).getAccountName()}</h3>
<h2>Balance:</h2>
<h2><c:out value="${customer.getAccounts().get(customer.getAccounts().size()-1).getBalance()}"/></h2>
