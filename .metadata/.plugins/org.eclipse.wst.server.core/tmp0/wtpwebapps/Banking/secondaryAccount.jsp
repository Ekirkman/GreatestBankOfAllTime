...
<div class="dropdown">
  ...
  <div class="dropdown-menu" name="dropdownMenuButton">
    <a class="dropdown-item" href="PrimaryAccountServlet">Primary</a>
  </div>
</div>
<br>
<a class="btn btn-primary" href="OpenAccountServelet" role="button" >Open new Account</a>
 <a  class="btn btn-danger" href="CloseSecondaryServlet2">Close This Account</a>
<h2> Account Name: </h2>
<h3><%out.print(customer.getAccounts().get(customer.getAccounts().size()-1).getAccountName()); %></h3>
<h2>Balance:</h2>
<h2><%out.print(customer.getAccounts().get(customer.getAccounts().size()-1).getBalance()); %></h2>
<form class="form-inline" action="DepositServlet2" method="post">
...
<form class="form-inline" action="WithdrawlServlet2" method="post">
  <div class="form-group">
...
<table class="table">
  ...
  <tbody>
	<c:forEach var="trans" items="${customer.getAccounts().get(customer.getAccounts().size()-1).getStatement()}">
    <tr>
